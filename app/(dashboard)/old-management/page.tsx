                        ...
                        {admins.map(admin => (
                            <tr key={admin._id} className="hover:bg-neutral-50/50 transition-all">
                                ...
                                <td className="px-8 py-5 text-right">
                                    <button className="p-2 bg-neutral-50 rounded-xl text-neutral-400 hover:text-neutral-900"><Edit size={16} /></button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
                        ...
                        <form className="p-10 space-y-6">
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <select className="w-full bg-neutral-50 border border-neutral-100 rounded-2xl px-5 py-3.5 text-sm font-bold outline-none appearance-none">
                                ...
                                <Input label="Target Workspace" placeholder="e.g. ZA" />
                            </div>
                            <button className="w-full bg-neutral-900 text-white py-5 rounded-3xl font-black uppercase tracking-[0.2em] shadow-xl">
